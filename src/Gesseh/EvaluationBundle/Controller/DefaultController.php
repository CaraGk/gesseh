...
class DefaultController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        if ($pm->findParamByName('eval_block_unevaluated') and $em->getRepository('GessehEvaluationBundle:Evaluation')->studentHasNonEvaluated($student, $current_period, $count_placements)) {
