 ...
 * @method sfGuardUser           setGessehEtudiant()        Sets the current record's "GessehEtudiant" collection
 * @method sfGuardUser           setGessehReferent()        Sets the current record's "GessehReferent" collection
 * 
 * @package    gesseh
 * @subpackage model
