 ...
 * @method year                getAnneePromo()       Returns the current record's "annee_promo" value
 ...
 * @method GessehEtudiant      setAnneePromo()       Sets the current record's "annee_promo" value
...
abstract class BaseGessehEtudiant extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('annee_promo', 'year', null, array(
             'type' => 'year',
             ));
