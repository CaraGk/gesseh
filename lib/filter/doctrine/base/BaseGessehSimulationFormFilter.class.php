...
/**
 * GessehSimulation filter form base class.
 *
 * @package    gesseh
 * @subpackage filter
 ...
 */
abstract class BaseGessehSimulationFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('gesseh_simulation_filters[%s]');
