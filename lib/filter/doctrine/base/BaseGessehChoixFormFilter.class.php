...
/**
 * GessehChoix filter form base class.
 *
 * @package    gesseh
 * @subpackage filter
 ...
 */
abstract class BaseGessehChoixFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('gesseh_choix_filters[%s]');
