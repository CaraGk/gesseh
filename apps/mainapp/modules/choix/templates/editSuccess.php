...
<?php else: ?>
  ...
  <?php else: ?>
    ...
    <?php else: ?>
      <div>Votre choix retenu par la simulation est : <strong><?php echo $monchoix->getGessehTerrain()->getTitre(); ?> (<?php echo $monchoix->getGessehTerrain()->getGessehFiliere()->getTitre(); ?>) à <?php echo $monchoix->getGessehTerrain()->getGessehHopital()->getTitre(); ?></strong>. Après vous, il reste encore <em><?php echo $monchoix->getReste(); ?> places</em> pour ce poste.</div>
    <?php endif; ?>
