...
Il ne vous restera ensuite plus qu'à <a href="<?php url_for('admEtudiant/index'); ?>">modifier manuellement les étudiants doublants</a> et à <a href="<?php url_for('admEtudiant/new'); ?>">ajouter les étudiants transférés</a>.</div>
